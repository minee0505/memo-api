    ...
    stages {
        stage('Checkout') {
            steps {
                ...
                git credentialsId: 'github-credentials', url: 'https://github.com/minee0505/memo-api.git', branch: 'main'
            }
        }
        ...
        stage('Deploy to EKS') {
            steps {
                ...
                script {
                    withCredentials([aws(credentialsId: 'aes-credentials')]) {
